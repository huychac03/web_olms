...
<div class="navbar-social pull-right visible-md visible-lg">
    <div class="fb-like" data-href="{{ \App\Models\Option::getvalue('fb_fanpage') }}" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
</div>